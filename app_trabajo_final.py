...
# CONEXIÓN (Usa los Secrets configurados en Streamlit Cloud)
...
# --- FASE 1: INSTRUCCIONES ---
    ...
    st.title("Dinámica")
    st.write("Imaginá que comprás una milanesa y tenés poco tiempo para decidir el postre...")
...
# --- FASE 3: OFERTA (SISTEMA 1) ---
    ...
    # REINCORPORACIÓN DE FOTOS Y TEXTOS
    postres = [
